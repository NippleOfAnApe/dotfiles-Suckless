# Generated by Powerlevel10k configuration wizard on 2022-02-20 at 02:13 EET.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=20
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND=48
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_FOREGROUND=48
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=120
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND=164
  ...
  typeset -g POWERLEVEL9K_ASDF_FOREGROUND=18
  typeset -g POWERLEVEL9K_ASDF_BACKGROUND=39
